...
<p id="consentInstructions" class="consent">
  ...
  <strong>Funding Source:</strong> Department funds<br><br>
  <u><strong>Invitation to Participate and Description of Project</strong></u><br>
  ...
  <u><strong>Description of Procedures</strong></u><br>
  If you agree to participate in this study, this Human Intelligence Task (HIT) will require you to (1) play a computer game using the computer mouse or keys on your keyboard and (2) answer simple questions about your demographics, health (including mental health), beliefs, and personality through an interactive web survey. You will never be asked for personally identifiable information such as your name, address, or date of birth.<br>
  The experiment is designed to take approximately 1 hour. You will have up to six hours to complete the experiment and submit codes for credit.<br><br>
  <u><strong>Risks and Inconveniences</strong></u><br>
  There are little to no risks associated with this study. Some individuals may experience mild boredom.<br><br>
  <u><strong>Economic Considerations</strong></u><br>
